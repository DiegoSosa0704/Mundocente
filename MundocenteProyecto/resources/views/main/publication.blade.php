...
@foreach($listPublications as $publication)
    <div id="result-announcement" class="ui raised card segment" style="width: 100%;">
                        ...
                        <div class="content">
                            ...
                            <a onclick="showDetailsPublication({{$publication->id_publication}})"><h5>{{$publication->title_publication}}</h5></a>
                        ...
                        <div class="ui items content">
                            <div class="item">
                                    ...
                                    {{--Institución--}}
                                    <div class="content">
                                        <a class="ui blue right ribbon label" style="left: 106%;">{{$publication->name_theme_notifications}}</a>
                                        <p></p>
                                            <div class="ui label">
                                                <i class="student icon"></i>
                                                <a class="detail">{{$publication->name_institution}}</a>
                                            </div>
                                        <br><p style="color:#484040;margin-top: 5px;">{{$publication->description_publication}}</p>

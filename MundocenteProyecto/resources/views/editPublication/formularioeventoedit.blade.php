                            ...
                            <div class="field">
                                <div class="ui  large horizontal label">Institución que publica el evento:
                                    <select name="country" class="ui search dropdown" id="selectMVinculation">
                                        <option value="{{$publication_uni->id_institution}}"
                                                selected="true">{{$publication_uni->name_institution}}</option>
                                    ...
                                    <div class="grouped fields">
                                        ...
                                        <div class="field">
                                            @if($publication_uni->sector_publication=='preescolar')
                                                <div class="ui checkbox checked">
                                                    <input type="checkbox" name="sector" id="sectorBasicCheck"
                                                           value="preescolar" checked="true">
                                        ...
                                        <div class="ui calendar" id="timeStart">
                                            <div class="ui input left icon">
                                                ...
                                                <input type="text" placeholder="Hora de inicio" id="inputvaluehourStart"
                                                       value="{{$publication_uni->hour_start}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="ui calendar" id="timeFinish">
                                            <div class="ui input left icon">
                                                ...
                                                <input type="text" placeholder="Ingrese hora de fin"
                                                       id="inputvaluehourFinish" value="{{$publication_uni->hour_end}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>

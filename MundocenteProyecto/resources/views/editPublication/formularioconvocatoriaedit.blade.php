                                    ...
                                    <div class="grouped fields">
                                        ...
                                        <div class="field">
                                            @if($publication_uni->sector_publication=='universitario')
                                                <div class="ui checkbox checked">
                                                    <input type="radio" name="sector" checked="checked"
                                                           id="sectorUniversityCheck"
                                                           value="universitario">
                                        ...
                                        <div class="field">
                                            @if($publication_uni->sector_publication=='preescolar')
                                                <div class="ui checkbox checked">
                                                    <input type="radio" name="sector" checked="checked"
                                                           id="sectorBasicCheck" value="preescolar">
                                                    <label>Preescolar, básica y media</label>
                                                </div>
                                            @else
                                                <div class="ui checkbox">
                                                    <input type="radio" name="sector" id="sectorBasicCheck"
                                                           value="preescolar">
                                                    <label>Preescolar, básica y media</label>
                                                </div>
                                            @endif

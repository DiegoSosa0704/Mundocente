            ...
            <div class="ui stackable equal width padded grid container">
                <div class="row">
                    ...
                    <div class="right floated column">
                        <a class="ui right floated  labeled icon button-publication blue button" target="_black"
                           href="publicar-convocatoria">
                            <i class="add icon"></i> Nueva convocatoria
                        </a>
                    </div>
                    <div class="right floated column">
                        <a class="ui right floated  labeled icon button-publication red button" target="_black"
                           href="publicar-evento">
                            <i class="add icon"></i> Nuevo evento
                        </a>
                    </div>
                    <div class="right floated column">
                        <a class="ui right floated  labeled icon button-publication green button" target="_black"
                           href="publicar-revista">
                            <i class="add icon"></i> Nueva Revista
                        </a>
                    </div>
                    <div class="right floated column">
                        <a class="ui right floated  labeled icon button-publication orange button" target="_black"
                ...
                <div class="column">
                    <div class="right floated column">
                        <a class="ui right floated  labeled icon button-publication red button" target="_black"
                           href="publicaciones-denunciadas">
                                ...
                                <tr class="center aligned">
                                    ...
                                    <td class="collapsing">
                                        @if($publicacion->state_publication=='activo')
                                            <button class="ui right floated small  labeled icon green button"
                                                    id="id_button_publication_publication{{$publicacion->id_publication}}"
                                                    onclick="publisdsjhjshdjshds({{$publicacion->id_publication}})">
                                                <i class="write icon"></i>
                                                <p id="id_active_edit_mensagge_publica_publica{{$publicacion->id_publication}}">
                                                    Activo</p>
                                            </button>
                                        @else
                                            <button class="ui right floated small  labeled icon red button"
                                                    id="id_button_publication_publication{{$publicacion->id_publication}}"
                                                    onclick="publjsdjshdjshd({{$publicacion->id_publication}})">
                                                <i class="write icon"></i>
                                                <p id="id_active_edit_mensagge_publica_publica{{$publicacion->id_publication}}">
                                                    Inactivo</p>
                                            </button>
                                    ...
                                    <td class="collapsing">
                                        ...
                                        @if($publicacion->state_user=='activo')
                                            <button class="ui right floated small  labeled icon green button"
                                                    id="id_button_publication{{$publicacion->id_publication}}"
                                                    onclick="usersoeppsoasiistteyrss({{$publicacion->id_user_fk}}, {{$publicacion->id_publication}})">
                                                <i class="user icon"></i>
                                                <p id="id_active_edit_mensagge_publica{{$publicacion->id_publication}}">
                                                    Activo</p>
                                            </button>
                                        @else
                                            <button class="ui right floated small  labeled icon red button"
                                                    id="id_button_publication{{$publicacion->id_publication}}"
                                                    onclick="usersoeppsoasi({{$publicacion->id_user_fk}}, {{$publicacion->id_publication}})">
                                                <i class="user icon"></i>
                                                <p id="id_active_edit_mensagge_publica{{$publicacion->id_publication}}">
                                                    Inactivo</p>
                                            </button>
                                    ...
                                    <td class="collapsing">
                                        @if($publicacion->id_type_publication==1)
                                            ...
                                            <input type="hidden" name="id_convocatoria_edit"
                                                   value="{{$publicacion->id_publication}}">
                                            <button target="_black" type="submit" class="ui basic button"
                                                    style="float: right;">Editar <i class="edit icon"> </i></button>
                                            {!!Form::close()!!}
                                        @elseif($publicacion->id_type_publication==2)
                                            {!!Form::open(['url'=>'editar-revista' , 'method'=>'POST'])!!}
                                            <input type="hidden" name="id_revista_edit"
                                                   value="{{$publicacion->id_publication}}">
                                            <button target="_black" type="submit" class="ui basic button"
                                                    style="float: right;">Editar <i class="edit icon"> </i></button>
                                            {!!Form::close()!!}
                                        @elseif($publicacion->id_type_publication==3)
                                            ...
                                            <input type="hidden" name="id_event_edit"
                                                   value="{{$publicacion->id_publication}}">
                                            <button target="_black" type="submit" class="ui basic button"
                                                    style="float: right;">Editar <i class="edit icon"> </i></button>
                                            {!!Form::close()!!}
                                        @else
                                            ...
                                            <input type="hidden" name="id_request_edit"
                                                   value="{{$publicacion->id_publication}}">
                                            <button target="_black" type="submit" class="ui basic button"
                                                    style="float: right;">Editar <i class="edit icon"> </i></button>
                                            {!!Form::close()!!}

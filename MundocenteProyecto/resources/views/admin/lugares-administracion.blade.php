                    ...
                    <table class="ui sortable celled unstackable table">
                        ...
                        @foreach($lugares as $country)
                            <tr class="center aligned">
                                ...
                                @endif
                                <input type="hidden" id="name_lugar_edit_show_dmin{{$country->id_lugar}}"
                                       value="{{$country->name_lugar}}">
                                <input type="hidden" id="type_place_edit{{$country->id_lugar}}"
                                       value="{{$country->type_lugar}}">
                                <input type="hidden" id="id_lugar_fk_edit_amin{{$country->id_lugar}}"
                                       value="{{$country->id_lugar_fk}}">
                                <td class="collapsing">
                                    <button class="ui right floated small  labeled icon button-edit-places color_3  color_3 button"
                                            onclick="show_modal_edit_place_admin({{$country->id_lugar}})">
